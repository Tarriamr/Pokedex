...
const mobileLinkBaseStyle = "block px-3 py-2 rounded-md text-base font-medium transition-colors duration-150 ease-in-out";
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="ml-3 flex h-7 items-center space-x-2">
                                            ...
                                            <button
                                                type="button"
                                                className={clsx(
                                                    "relative rounded-md p-1", // Padding dla tła hover
                                                    "text-pokemon-gray-dark dark:text-pokemon-gray-light",
                                                    "hover:bg-pokemon-gray-medium dark:hover:bg-pokemon-gray-dark", // Hover tło
                                                    "focus:outline-none", // Usuń domyślny outline
                                                    "focus-visible:ring-2 focus-visible:ring-pokemon-yellow focus-visible:ring-offset-2", // Ring dla focus-visible
                                                    "transition-colors duration-150 ease-in-out" // Transition
                                                )}
                                                onClick={onClose}
