        ...
        <div className="absolute top-3 left-3 flex space-x-2 z-10">
            ...
            <button
                ...
                className={clsx(
                    ...
                    "text-pokemon-red",
                    !isUpdatingFavorite && "hover:text-pokemon-gray-darker dark:hover:text-pokemon-gray-light"
                )}
            ...
            <button
                ...
                className={clsx(
                    ...
                    !isUpdatingArena && canAddToArena && "hover:text-pokemon-blue-darker dark:hover:text-pokemon-blue"
                )}
