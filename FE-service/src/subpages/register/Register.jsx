    ...
    >
      ...
      >
        ...
        <h1
          ...
          className="text-3xl font-bold text-center text-pokemon-green-dark dark:text-pokemon-green mb-6"
        >
          Rejestracja
        </h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            <button
              ...
              disabled={isLoading}
              className={clsx(
                "w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-pokemon-green hover:bg-pokemon-green-dark",
                "focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-pokemon-green-dark",
