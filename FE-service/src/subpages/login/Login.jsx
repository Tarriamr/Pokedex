    ...
    >
      ...
      >
        ...
        <h1
          ...
          className="text-3xl font-bold text-center text-pokemon-blue-dark dark:text-pokemon-blue-light mb-6"
        >
          Logowanie
        </h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            <button
              ...
              disabled={isLoading}
              className={clsx(
                "w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-pokemon-yellow hover:bg-pokemon-yellow-dark",
                "focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-pokemon-yellow-dark",
                "disabled:opacity-50 disabled:cursor-not-allowed",
                "transition-colors duration-150 ease-in-out",
                "text-pokemon-blue-dark",
              )}
            >
              {isLoading ? (
                <>
                  <svg
                    className="animate-spin -ml-1 mr-3 h-5 w-5 text-pokemon-blue-dark"
