...
export const combinePokemonData = (baseDetails, userStat, pokemonId) => {
    ...
    if (effectiveBaseDetails) {
        const combined = {
            ...
            base_experience: isCustom
                ...
                : safeGetNumber(stats.modified_base_experience ?? effectiveBaseDetails.base_experience, 0), // Default to 0 for derived/base exp
            ...
            api_base_experience: !isCustom && effectiveBaseDetails.base_experience !== undefined ? effectiveBaseDetails.base_experience : undefined,
    ...
    if (isCustom && Object.keys(stats).length > 0) {
        console.warn(`[combinePokemonData] Brak danych bazowych dla customowego Pokemona ${pokemonIdStr}. Używanie tylko userStats.`);
        return {
            id: pokemonIdNum,
            image: getPokemonImageUrl(pokemonIdNum),
    ...
    console.error(`[combinePokemonData] Nie można połączyć danych dla Pokemona ${pokemonIdStr}. ` +
